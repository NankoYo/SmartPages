...
const CONFIG = {
  ...
  STARTER_FOOTER_PRIVACY_POLICY_URL: '/privacy_policy',

  STARTER_FOOTER_PRIVACY_LEGAL_NOTICE_TEXT: '法律声明',
  STARTER_FOOTER_PRIVACY_LEGAL_NOTICE_URL: '/Legal_Notices',

  STARTER_FOOTER_PRIVACY_TERMS_OF_SERVICE_TEXT: '服务协议',
  STARTER_FOOTER_PRIVACY_TERMS_OF_SERVICE_URL: '/service_agreement',
  ...
  STARTER_POST_REDIRECT_URL: 'https://Vallengine.com', // 重定向域名
