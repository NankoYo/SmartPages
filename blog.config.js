...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'eeb10e13d93748a9b997f577cbfd8beb',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'vallengine', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '云谷引擎（Vallengine）是一个为数百万企业和开发者提供安全稳定的云计算服务的平台。它提供了全方位的云服务和各行业解决方案，包括云服务器、云数据库、云存储、视频与CDN、域名注册等。无论是大型企业还是个人开发者，都可以依靠云谷引擎来满足他们的云计算需求。', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://Vallengine.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '云谷,Vallengine,云服务器,云主机,CDN,对象存储,域名注册备案,云存储,云数据库,互联网+解决方案', // 网站关键词 英文逗号隔开
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '云谷引擎（Vallengine）', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || '云谷引擎（Vallengine）是一个为数百万企业和开发者提供安全稳定的云计算服务的平台。它提供了全方位的云服务和各行业解决方案，包括云服务器、云数据库、云存储、视频与CDN、域名注册等。无论是大型企业还是个人开发者，都可以依靠云谷引擎来满足他们的云计算需求。', // 站点描述，被notion中的页面描述覆盖
